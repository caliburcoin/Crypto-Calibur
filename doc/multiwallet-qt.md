...
In order to support loading of multiple wallets in calibur-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is calibur.cpp.
...
Changes to calibur.cpp
----------------------
calibur.cpp is the entry point into calibur-qt, and as such, will require some minor modifications to provide hooks for
