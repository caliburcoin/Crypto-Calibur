Contributing to CALIBUR Core
============================

The CALIBUR Core project operates an open contributor model where anyone is
...
The following applies to code changes to the CALIBUR Core project, and is not to be
confused with overall CALIBUR Network Protocol consensus changes.

Whether a pull request is merged into CALIBUR Core rests with the project merge
...
Patches that change CALIBUR consensus rules are considerably more involved than
...
Where a patch set proposes to change the CALIBUR consensus, it must have been
...
The project leader is the release manager for each CALIBUR Core release.
