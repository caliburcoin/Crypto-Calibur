...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "CALIBUR server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* CALIBUR features */
        {"calibur", "listmasternodes", &listmasternodes, true, true, false},
        {"calibur", "getmasternodecount", &getmasternodecount, true, true, false},
        {"calibur", "masternodeconnect", &masternodeconnect, true, true, false},
        {"calibur", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"calibur", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"calibur", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"calibur", "masternodecurrent", &masternodecurrent, true, true, false},
        {"calibur", "masternodedebug", &masternodedebug, true, true, false},
        {"calibur", "startmasternode", &startmasternode, true, true, false},
        {"calibur", "createmasternodekey", &createmasternodekey, true, true, false},
        {"calibur", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"calibur", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"calibur", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"calibur", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"calibur", "getmasternodescores", &getmasternodescores, true, true, false},
        {"calibur", "preparebudget", &preparebudget, true, true, false},
        {"calibur", "submitbudget", &submitbudget, true, true, false},
        {"calibur", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"calibur", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"calibur", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"calibur", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"calibur", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"calibur", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"calibur", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"calibur", "checkbudgets", &checkbudgets, true, true, false},
        {"calibur", "mnsync", &mnsync, true, true, false},
        {"calibur", "spork", &spork, true, true, false},
        {"calibur", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzcbrseed", &getzcbrseed, false, false, true},
        {"zerocoin", "setzcbrseed", &setzcbrseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzcbr", &searchdzcbr, false, false, true},
        {"zerocoin", "dzcbrstate", &dzcbrstate, false, false, true},
...
{
    return "> calibur-cli " + methodname + " " + args + "\n";
}
