...
/**
 * CALIBUR RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzcbrseed(const UniValue& params, bool fHelp);
extern UniValue getzcbrseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzcbr(const UniValue& params, bool fHelp);
extern UniValue dzcbrstate(const UniValue& params, bool fHelp);
