...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("000006e294c346db8526e6455f792f5dd7e07203ad96fd54f85138f3126eb5fc")); //!< Network split here
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1557927515, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("045af61f76c1603925eac2f1684adfccf650fe7cd662039328af36bf1605a0fbec4e5c5ff46a1dab49bda7664544ba8d9e8ed70742797b4296ddd5b2ef78640edd") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime = 1557927515;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 3142345;
		MineGenesis(genesis);
        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("000006e294c346db8526e6455f792f5dd7e07203ad96fd54f85138f3126eb5fc"));
      ...
      //  vSeeds.push_back(CDNSSeedData(","));           // Single node address
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x02)(0xDD)(0x15)(0x44).convert_to_container<std::vector<unsigned char> >();
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x02)(0xEE)(0x13)(0xB0).convert_to_container<std::vector<unsigned char> >();
        ...
        nZerocoinRequiredStakeDepth = 200; //The required confirmations for a zcbr to be stakable
...
public:
    CTestNetParams()
    {
        ...
        // Testnet calibur BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet calibur BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet calibur BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // CALIBUR: 1 day
        nTargetSpacing = 1 * 60;        // CALIBUR: 1 minutes
