...
#ifndef CALIBUR_ZCBRWALLET_H
#define CALIBUR_ZCBRWALLET_H
...
public:
    CzCBRWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZCBR(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZCBR(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
