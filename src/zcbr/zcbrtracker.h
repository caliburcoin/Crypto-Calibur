...
#ifndef CALIBUR_ZCBRTRACKER_H
#define CALIBUR_ZCBRTRACKER_H
...
public:
    CzCBRTracker(std::string strWalletFile);
    ~CzCBRTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzCBRWallet* zCBRWallet = NULL);
