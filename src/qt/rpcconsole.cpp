                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzCBRPathCustom = GetArg("-zcbrbackuppath", "");
    ...
    if(!strzCBRPathCustom.empty()) {
        ui->wallet_customzcbrbackuppath->setText(QString::fromStdString(strzCBRPathCustom));
        ui->wallet_customzcbrbackuppath_label->setVisible(true);
        ui->wallet_customzcbrbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzCBRPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the CALIBUR RPC console.") + "<br>" +
