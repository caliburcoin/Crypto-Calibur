...
/** Utility functions used by the CALIBUR Qt UI.
 */
namespace GUIUtil
{
...
// Render CALIBUR addresses in monospace font
...
// Parse "calibur:" URI into recipient object, return true on successful parsing
