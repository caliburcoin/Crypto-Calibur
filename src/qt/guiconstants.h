...
/* Calibur GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "CALIBUR"
#define QAPP_ORG_DOMAIN "calibur.org"
#define QAPP_APP_NAME_DEFAULT "CALIBUR-Qt"
#define QAPP_APP_NAME_TESTNET "CALIBUR-Qt-testnet"
