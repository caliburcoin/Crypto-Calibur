/* src/config/calibur-config.h.  Generated from calibur-config.h.in by configure.  */
/* src/config/calibur-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.calibur.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Calibur Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Calibur Core 1.1.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "calibur"
