...
public:
    ...
    bool IsDust(CFeeRate minRelayTxFee) const
    {
        ...
        // i.e. total is 148 + 32 = 182 bytes. Default -minrelaytxfee is 20000 upiv per kB
        // and that means that fee per txout is 182 * 20000 / 1000 = 1820 upiv.
        // So dust is a txout less than 1820 *3 = 5460 upiv
        // with default -minrelaytxfee = minRelayTxFee = 20000 upiv per kB.
