...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Calibur Core calibur-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  calibur-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded calibur transaction") + "\n" +
                               "  calibur-tx [options] -create [commands]   " + _("Create hex-encoded calibur transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded calibur transaction
