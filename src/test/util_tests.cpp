...
BOOST_AUTO_TEST_CASE(util_FormatMoney)
{
    ...
    BOOST_CHECK_EQUAL(FormatMoney((COIN/20000)*123456789, false), "12345.6789");
    ...
    BOOST_CHECK_EQUAL(FormatMoney(COIN*20000, false), "20000.00");
    ...
    BOOST_CHECK_EQUAL(FormatMoney(COIN/20000, false), "0.0001");
...
BOOST_AUTO_TEST_CASE(util_ParseMoney)
{
    ...
    BOOST_CHECK_EQUAL(ret, (COIN/20000)*123456789);
    ...
    BOOST_CHECK(ParseMoney("20000.00", ret));
    BOOST_CHECK_EQUAL(ret, COIN*20000);
...
BOOST_AUTO_TEST_CASE(util_seed_insecure_rand)
{
    ...
    for (int mod=2;mod<11;mod++)
    {
        ...
        int err = 30*20000./mod*sqrt((1./mod*(1-1./mod))/20000.);
        ...
        BOOST_CHECK(count<=20000/mod+err);
        BOOST_CHECK(count>=20000/mod-err);
    }
}
