...
BOOST_AUTO_TEST_CASE(rpc_format_monetary_values)
{
    ...
    BOOST_CHECK_EQUAL(ValueFromAmount((COIN/20000)*123456789).write(), "12345.67890000");
    ...
    BOOST_CHECK_EQUAL(ValueFromAmount(COIN*20000).write(), "20000.00000000");
    ...
    BOOST_CHECK_EQUAL(ValueFromAmount(COIN/20000).write(), "0.00010000");
