#!/usr/bin/env python3
# Copyright (c) 2019 The CALIBUR Core developers
...
from fake_stake.base_test import CALIBUR_FakeStakeTest

class zCBRwrappedSerialsTest(CALIBUR_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zCBRs..." % DENOM_TO_USE)
