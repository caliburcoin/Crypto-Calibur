...
RESOURCES += src/qt/calibur.qrc src/qt/calibur_locale.qrc

TRANSLATIONS += src/qt/locale/calibur_bg.ts \
                src/qt/locale/calibur_de.ts \
                src/qt/locale/calibur_en.ts \
                src/qt/locale/calibur_es.ts \
                src/qt/locale/calibur_fi.ts \
                src/qt/locale/calibur_fr.ts \
                src/qt/locale/calibur_it.ts \
                src/qt/locale/calibur_ja.ts \
                src/qt/locale/calibur_pl.ts \
                src/qt/locale/calibur_pt.ts \
                src/qt/locale/calibur_ru.ts \
                src/qt/locale/calibur_sk.ts \
                src/qt/locale/calibur_sv.ts \
                src/qt/locale/calibur_vi.ts \
                src/qt/locale/calibur_zh_CN.ts \
                src/qt/locale/calibur_zh_TW.ts
