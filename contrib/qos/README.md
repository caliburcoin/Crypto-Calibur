...
This means one can have an always-on caliburd instance running, and another local caliburd/calibur-qt instance which connects to this node and receives blocks from it.
